...
Инструкции по выполнению домашнего задания:  
  ...
  - Задания выполняются в группах по 2 человека  
...
### Неделя 02 – Условные и повторяющиеся инструции  
  ...
  **Домашнее задание (от 25.09 до 08.10)**:  
    1) Разработать список 02 из 3 упражнений из **файла docs/list02_dz.pdf** [link] (https://drive.google.com/drive/folders/1hoa2qrgVboxmyOSnmT8uuJjLqbVRpDS8)  
      (разработать исходный код + подготовить отчет с блок-схема  + скриншот 2 тестов в отчете + публикация на GitHub)  
    ...
    2) Проведите эксперименты с отладчиком и/или терминалом, используя разные значения переменных и проверьте обновленные значения переменных (задачи 9.1, 9.2, 9.3) из файла **docs/lab1.cpp** [ссылка] (https:/ /drive .google.com/drive/folders/1hoa2qrgVboxmyOSnmT8uuJjLqbVRpDS8).  
