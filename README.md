...
------------------------  
  ...
  **Домашнее задание (от 25.11 до 06.12)**:  
    1) Объедините 2 рабочие группы (всего студентов должно быть 4) и разработайте упражнение 03 из файла **docs/list07.pdf** (в репозитории Google Диска);   
    2) Каждая структура должна содержать файл .h и .cpp, в котором определены атрибуты и методы;   
    3) Основная программа должна быть определена в файле main.cpp и содержать в функции main() главное меню опций:   
       - Управление клиентом  
       - Управление продуктом  
       - Управление заказом (необходимо указать детали заказа)  
    4) При выборе пункта главного меню должно открыться подменю с операциями CRUD+ выбранной структуры.  
