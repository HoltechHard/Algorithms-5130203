...
### Неделя 02 – Условные и повторяющиеся инструции  
  ...
  **Домашнее задание (от 25.09 до 08.10)**:  
    ...
    2) Проведите эксперименты с отладчиком и/или терминалом, используя разные значения переменных и проверьте обновленные значения переменных (задачи 9.1, 9.2, 9.3) из файла **docs/lab1.cpp**.  
