...
### Урок 10 - Зкзамен и Курсовая работа   
----------------------------------------    
   
**1-я контрольная работе - перездача (16.12.24):**  
  - 1 вопрос по условие + 1 вопрос по цикль/массив   
  - времени: 1 час от 10:10 до 11:10
  - Перездача рекомендуется только для студентов имеющих <= 70 на балл по 1-й контроля  
    
**Курсовая работе (17.12.24):**       
    - прочитайте указания в файле **week09_dz/kursovaya_part01** (есть на русском и на английском языках) и следуйте инструкциям, чтобы завершить проект курсовая работа;   
    - Все студенты в каждой группе должны присутствовать в день презентации для оценки итогового проекта;  
      * День презентации: 17.12.24   
      * Время: 13:00 - 15:40   
      * место: кабинет 11к-343   
    - Презентация состоит из 3-х частей:  
        * 1- презентация функциональности системы;  
        * 2- объяснение исходного кода, используемых структур данных и их взаимодействия с его операциями;  
        * 3- раунд вопросов (1 теория + 1 практика по системе)  
    - Рабочик группы по 4 студентов (1 по каждому структр) - страрость **Илья Ефанов** определять список по excel файл       
